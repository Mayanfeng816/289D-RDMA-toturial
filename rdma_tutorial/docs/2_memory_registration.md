...
Memory Registration is the process of informing the RDMA NIC, also known as Host Channel Adapter. The most important point of it is that a region of application memory may be directly accessed via direct memory access.
